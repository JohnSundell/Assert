 ...
 */
func assert<T, E: Error>(at file: StaticString = #file,
            line: UInt = #line,
 ...
 */
func assertErrorThrown<T, E: Error>(at file: StaticString = #file,
                       line: UInt = #line,
 ...
 */
func assertNoErrorThrown<T>(at file: StaticString = #file, line: UInt = #line, from closure: () throws -> T) {
    do {
        _ = try closure()
    } catch {
